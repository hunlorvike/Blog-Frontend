        ...
        <div class="row">
          <div class="col-lg-8 m-auto">
            <div class="contact">
              ...
              <form action="https://demo-noonpost.assiagroupe.net/html/assets/php/mail.php"
                    class="widget-form contact_form " method="POST" id="main_contact_form">
                <h5>Feel free to contact any time.</h5>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates, repudiandae.
                </p>
